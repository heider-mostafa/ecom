    ...
    <>
      <div className="relative h-[80vh] overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/3_0ece2565-5527-41e8-b43b-3e87b001289c.jpg-mIo8uZxbKjN3fn9OeAryRFwgqogUrh.png"
            alt="Lip gloss applicators arranged in a row showing different shades"
            fill
        ...
        <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <h2 className="text-5xl font-bold mb-4">Say Goodbye To Small Lips</h2>
...
function VideoTestimonials() {
  const testimonials = [
    ...
    { 
      ...
      poster: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202024-12-06%20at%203.58.27%E2%80%AFPM-nW0Rq9Yg6iTQxTNLJGZ6yJzWiFQfEj.png"
    },
    { 
      id: 4, 
      name: "Alex K.", 
